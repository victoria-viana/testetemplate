class EstoquesController < ApplicationController
  ...
  private
    ...
    def estoque_params
      params.require(:estoque).permit(:cliente_id, :veiculo_id, :chave, :funciona, :data_entrada, :banco_id, :responsavel_entrada, :reboque, :cidade_id, :tipo_entrada_id, :data_saida, :responsavel_saida)
    end
end
